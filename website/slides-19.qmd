---
title: "Lecture 19: Introduction to deep learning and computer vision"
author: "Firas Moosvi"
format: 
    revealjs:
...
- A fantastic explanation of [Neural Networks](https://youtu.be/aircAruvnKk?si=p6zUZbdPzAdEfdlo) from 3Blue1Brown.

## Neural networks example and terminology

![](img/nn-10.png)

## (Optional) How does training work in neural networks? {.smaller}

This is a high-level overview of Neural Networks.
...
This is a great explainer of CNNs: [poloclub.github.io/cnn-explainer/](https://poloclub.github.io/cnn-explainer/)

![](img/cnn_explainer.gif)
