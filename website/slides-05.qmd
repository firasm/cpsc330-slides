...
- Introducing [BrightSpace](https://ubc.brightspace.com/d2l/home/6706)!
...
<!--
- I am away this Thursday and next Tuesday for EAAI 2026
  - EAAI is the Symposium on Educational Advances in Artificial Intelligence in Singapore
  - "Effective Strategies for Teaching Machine Learning"
- Other instructors Dr. Giulia Toti (Thursday) and Dr. Mehrdad Oveisi (Tuesday) will teach !
- Heads up: they won't use Agora (or iClicker) for class participation ; just show of hands
...
## Clicker 5.1
Participate using [Agora](https://agora.students.cs.ubc.ca) (code: cpsc330-2026W1)
...
The question is adapted from [here](https://developers.google.com/machine-learning/crash-course/overfitting).
...
- 
For this demo, each student should [click this link](https://github.com/new?template_name=lecture05_demo&template_owner=ubc-cpsc330) to create a new repo in their accounts, then clone that repo locally to follow along with the demo from today.
