...
description-short: 'Terminology and Decision Trees'
format:
  revealjs:
    slide-number: true
    smaller: true
...
-->
- You can find the tentative due dates for all deliverables [here](https://ubc-cs.github.io/cpsc330-2026S1/#deliverable-due-dates-tentative).
...
- [ ] Are you able to access [course forum: Ed Discussion](https://canvas.ubc.ca/courses/178047/external_tools/61383)?
- [ ] Are you able to access [Gradescope](https://canvas.ubc.ca/courses/178047/external_tools/64398)? (If not, refer to the [Gradescope Student Guide](https://lthub.ubc.ca/guides/gradescope-student-guide/).)
<!-- - [ ] Are you able to access [iClicker Cloud](https://join.iclicker.com/YJHS) for this course? -->
- [ ] Did you follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2026S1/docs/setup) to create a course conda environment on your computer?
...
- In the `class` folder, you will clone the `cpsc330-2026S1` repo which contains all the class jupyter notebooks
...
## Clicker 2.2: Supervised vs unsupervised {.smaller}
...
## Clicker 2.3: Classification vs. Regression {.smaller}
...
## Clicker 2.4: Baselines and Decision trees {.smaller}
