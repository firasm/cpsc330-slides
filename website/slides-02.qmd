...
- In the `class` folder, you will clone the `cpsc330-2026W1` repo which contains all the class jupyter notebooks
...
## Toy job happiness dataset {.smaller}
...
Participate using Agora (code: cpsc330-2026W1) 
