...
You can [find the demo repo here](https://github.com/ubc-cpsc330/lecture3_demo), though you have probably created a repo already locally from Thursday.

**You can find the [finished version of the repo in my demo account after class](https://github.com/demofiras/class3_demo).**
