...
- Midterm next week! Important information about Midterm 1
  - [Piazza Post](https://piazza.com/class/m01ukubppof625/post/249)
  - **Good news for you: You will have access to our course notes in the midterm!**
...
For this demo, each student should [click this link](https://github.com/new?template_name=lecture11_demo&template_owner=ubc-cpsc330) to create a new repo in their accounts, then clone that repo locally to follow along with the demo from today.
