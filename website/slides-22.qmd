---
title: "Lecture 22: Communication and Conclusion"
author: "Firas Moosvi"
format: 
    revealjs:
...
## Clicker (Survival analysis recap) {.smaller}
...
Complete the [SEoI for this course here](https://go.blueja.io/e44WErUW-EOdnu6gTrHTmg)

![](img/course_eval_2026S1.png)
...
<!-- # [Class demo](https://github.com/UBC-CS/cpsc330-2026S1/blob/main/lectures/102-Varada-lectures/class_demos/demo_21-communication.ipynb)  -->
...
<!-- Adding Lecture 24 stuff to make it all one Lecture!
...
For this demo, each student should [click this link](https://github.com/new?template_name=lecture24_demo&template_owner=ubc-cpsc330) to create a new repo in their accounts, then clone that repo locally to follow the steps to deloy an app.
