...
::: {.callout-important}
Please read [this entire document about asking for help](https://ubc-cs.github.io/cpsc330-2026S1/docs/asking_for_help).
**TLDR:** Be nice.
:::
...
- Follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2026S1/docs/setup) to create a course `conda` environment on your computer. 
...
- The grading breakdown is [here](https://ubc-cs.github.io/cpsc330-2026S1/syllabus/#grading-scheme). 
- The policy on challenging grades is [here](https://ubc-cs.github.io/cpsc330-2026S1/docs/grades#reasonable-grading-concerns).
...
Read [https://ubc-cs.github.io/cpsc330-2026S1/docs/330_vs_340](https://ubc-cs.github.io/cpsc330-2026S1/docs 330_vs_340) which explains the difference between two courses.  
