...
::: {.callout-important}
Course website: [https://ubc-cs.github.io/cpsc330-2026S1](https://ubc-cs.github.io/cpsc330-2026S1) is the most important link. You can access the course website from Canvas.
...
::: {.callout-important}
Please go through [this document](https://ubc-cs.github.io/cpsc330-2026S1/syllabus/#registration) carefully before contacting your instructors about these issues. Even then, we are very unlikely to be able to help with registration, waitlist or prerequisite issues.
:::
...
[https://htmlpreview.github.io/?https://github.com/UBC-CS/cpsc330-2026S1/blob/main/docs/calendar.html](https://htmlpreview.github.io/?https://github.com/UBC-CS/cpsc330-2026S1/blob/main/docs/calendar.html)
 -->
...
- Our main forum for getting help will be [Ed Discussion](https://edstem.org/us/join/BMH77Z).

::: {.callout-important}
Please read [this entire document about asking for help](https://ubc-cs.github.io/cpsc330-2026S1/docs/asking_for_help.html).
**TLDR:** Be nice.
:::
...
- **Recommended Browsers:** [Microsoft Edge](https://www.microsoft.com/en-us/edge/download), or [Mozilla Firefox](https://www.mozilla.org/en-US/firefox/new/)or [Safari](https://www.apple.com/ca/safari/). Google Chrome is *not* recommended for [reasons](https://www.zdnet.com/article/google-may-have-downloaded-a-4gb-chrome-file-to-your-pc-heres-why/)...

## Course `conda` environment

- Follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2026S1/docs/setup.html) to create a course `conda` environment on your computer. 
...
but you can find some useful Python resources [here](https://github.com/UBC-CS/cpsc330-2026S1/blob/main/docs/resources.md).  
:::
...
- In addition to the "live" notebooks, Jupyter notebooks can be statically rendered in the web browser, e.g. [this](https://github.com/UBC-CS/cpsc330-2026S1/blob/main/lectures/01_intro.ipynb).
...
- All the lectures from last year are [available here](https://ubc-cs.github.io/cpsc330-2025W2).
- We cannot promise anything will stay the same from last year to this year, so read them in advance at your own risk.
- A "finalized" version will be pushed to [GitHub](https://github.com/UBC-CS/cpsc330-2026S1) and the [Jupyter book](https://ubc-cs.github.io/cpsc330-2026S1) right before each class.
...
https://github.com/UBC-CS/cpsc330-2026S1/tree/main/lectures/103-Firas-lectures

## Grades

- The grading breakdown is [here](https://ubc-cs.github.io/cpsc330-2026S1/syllabus.html#grading-scheme). 
- The policy on challenging grades is [here](https://ubc-cs.github.io/cpsc330-2026S1/docs/grades.html#reasonable-grading-concerns).
...
- You can install Edge [here](https://www.microsoft.com/en-us/edge/download).
...
Read [https://ubc-cs.github.io/cpsc330-2026S1/docs/330_vs_340.html](https://ubc-cs.github.io/cpsc330-2026S1/docs 330_vs_340.html) which explains the difference between two courses.  
