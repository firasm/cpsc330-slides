...
::: {.callout-important}
Course website: [https://ubc-cs.github.io/cpsc330-2026W1](https://ubc-cs.github.io/cpsc330-2026W1) is the most important link. You can access the course website from Canvas.
...
::: {.callout-important}
Please go through [this document](https://ubc-cs.github.io/cpsc330-2026W1/syllabus/#registration) carefully before contacting your instructors about these issues. Even then, we are very unlikely to be able to help with registration, waitlist or prerequisite issues.
:::
...
- The waitlist will close at the end of the day on Wednesday September 16 at 3 PM; after this, no more students will be able to register after that!
- It is your responsibility to catch up on any missed work.

## Lecture format

- In person lectures Tuesday and Thursday from 3:30 PM to 5 PM
...
[https://htmlpreview.github.io/?https://github.com/UBC-CS/cpsc330-2026W1/blob/main/docs/calendar.html](https://htmlpreview.github.io/?https://github.com/UBC-CS/cpsc330-2026W1/blob/main/docs/calendar.html)
 -->
...
## Important note 
- Note that your first homework assignment is due **Monday, September 14, 11:59 PM** (check the [course schedule](https://ubc-cs.github.io/cpsc330-2026W1/README.html#deliverable-due-dates-tentative)). This is a relatively straightforward assignment on Python. 
...
::: {.callout-important}
Please read [this entire document about asking for help](https://ubc-cs.github.io/cpsc330-2026W1/docs/asking_for_help).
**TLDR:** Be nice.
:::
...
- Follow the setup instructions [here](https://ubc-cs.github.io/cpsc330-2026W1/docs/setup) to create a course `conda` environment on your computer. 
...
- In addition to the "live" notebooks, Jupyter notebooks can be statically rendered in the web browser, e.g. [this](https://github.com/UBC-CS/cpsc330-2026W1/blob/main/lectures/01_intro.ipynb).
...
- The grading breakdown is [here](https://ubc-cs.github.io/cpsc330-2026W1/syllabus/#grading-scheme). 
- The policy on challenging grades is [here](https://ubc-cs.github.io/cpsc330-2026W1/docs/grades#reasonable-grading-concerns).
...
Read [https://ubc-cs.github.io/cpsc330-2026W1/docs/330_vs_340](https://ubc-cs.github.io/cpsc330-2026W1/docs 330_vs_340) which explains the difference between two courses.  
